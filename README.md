...
The personal brand / conversion landing page for **Kobey Broussard** — AI
automation & full-stack developer. It's the hub I point clients, freelance
profiles, and pitches to.
...
Plain HTML/CSS/JS, no build step. Deployed on Firebase Hosting.
...
- [Juniper Table restaurant demo](https://kobeydev.web.app/demos/juniper-table/) — restaurant website with reservations, order-ahead cart, menu, events, hours, and reviews.
- [LeasePilot property app demo](https://kobeydev.web.app/demos/leasepilot/) — property-management dashboard with maintenance tickets, rent status, vendors, inspections, and work-order detail.
...
- [jira-ticket-triage-demo](https://github.com/git-agent-swarm/jira-ticket-triage-demo) — Jira Cloud ticket triage and issue payload automation proof with mocked tests.
- [composio-tool-router-demo](https://github.com/git-agent-swarm/composio-tool-router-demo) — no-secret connector router proof for Composio-style agent tool actions.
